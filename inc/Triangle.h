...
class Triangle : public Shape{
    ...
    /* 
        ...
        */
        ...
        /* 
        * This is a constructor for a Triangle object created with a matrix and integer color
        * 
        * Parameters:
        *  verticies - pointer to the verticies object to be used as triangle coordinates
        ...
        */
        Triangle(unsigned int x0, unsigned int y0, unsigned int z0, unsigned int x1, unsigned int y1, unsigned int z1, unsigned int x2, unsigned int y2, unsigned int z2);
        ...
        *  blue - color value for blue
        */
        Triangle(unsigned int x0, unsigned int y0, unsigned int z0, unsigned int x1, unsigned int y1, unsigned int z1, unsigned int x2, unsigned int y2, unsigned int z2, int red, int green, int blue);
    ...
    private:
        ...
        */
        void initTriangleVerticies(unsigned int x0, unsigned int y0, unsigned int z0, unsigned int x1, unsigned int y1, unsigned int z1, unsigned int x2, unsigned int y2, unsigned int z2);
};
